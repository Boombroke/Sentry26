...
#ifndef SENTRY_BEHAVIOR__PLUGINS__DECORATOR__RATE_CONTROLLER_HPP_
#define SENTRY_BEHAVIOR__PLUGINS__DECORATOR__RATE_CONTROLLER_HPP_
...
public:
  /**
   * @brief A constructor for sentry_behavior::RateController
...
#endif  // SENTRY_BEHAVIOR__PLUGINS__DECORATOR__RATE_CONTROLLER_HPP_
